...
namespace ContosoUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult AddCourse([Bind(Include = "CourseID, StudentID, Grade")]Enrollment course)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID, LastName, FirstMidName, EnrollmentDate, Notes")]Student student)
        {
            try
            {
                if (ModelState.IsValid)
